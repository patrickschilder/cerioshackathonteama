        ...
        <div>
          {currentSlide ? (
            <div className="card" style={{ minHeight: 400 }}>
              <div className="card-header" style={{ background: "var(--color-primary)", margin: "calc(-1 * var(--space-6))", marginBottom: "var(--space-6)", padding: "var(--space-6)", borderRadius: "var(--radius-lg) var(--radius-lg) 0 0" }}>
              ...
              {currentSlide.notes && (
                <div style={{ marginTop: "var(--space-6)", padding: "var(--space-4)", background: "var(--color-surface-alt)", borderRadius: "var(--radius-md)", borderLeft: "4px solid var(--color-accent)" }}>
